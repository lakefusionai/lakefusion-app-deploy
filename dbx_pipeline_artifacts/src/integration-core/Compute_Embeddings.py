...
add_col_tables = [master_table, unified_table]
if unified_dedup_exists:
    add_col_tables.append(unified_dedup_table)
else:
    logger.info(f"Unified dedup table does not exist ({unified_dedup_table}), skipping column add")
