...
from lakefusion_core_engine.executors.tasks.integration_core.normal_deduplication import ProcessAutoMergeExecutor

# COMMAND ----------

# Build context with all required parameters
context = TaskContext(
    task_name="Process_Auto_Merge",
    entity=entity,
...
executor = ProcessAutoMergeExecutor(context)
