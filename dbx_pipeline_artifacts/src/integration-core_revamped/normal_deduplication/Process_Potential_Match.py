...
from lakefusion_core_engine.executors.tasks.integration_core.normal_deduplication import ProcessPotentialMatchExecutor

# COMMAND ----------

# Build context with all required parameters
context = TaskContext(
    task_name="Process_Potential_Match",
    entity=entity,
...
executor = ProcessPotentialMatchExecutor(context)
