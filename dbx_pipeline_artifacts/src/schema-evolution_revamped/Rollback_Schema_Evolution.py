...
from lakefusion_core_engine.executors.tasks.schema_evolution import RollbackSchemaEvolutionExecutor

# COMMAND ----------

# Build context
context = TaskContext(
    task_name="Rollback_Schema_Evolution",
    entity="",
...
executor = RollbackSchemaEvolutionExecutor(context)
