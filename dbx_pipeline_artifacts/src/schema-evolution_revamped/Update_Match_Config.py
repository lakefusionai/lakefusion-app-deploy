...
from lakefusion_core_engine.executors.tasks.schema_evolution import UpdateMatchConfigExecutor

# COMMAND ----------

# Build context
context = TaskContext(
    task_name="Update_Match_Config",
    entity=entity_name,
...
executor = UpdateMatchConfigExecutor(context)
