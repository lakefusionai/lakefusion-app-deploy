...
from lakefusion_core_engine.executors.tasks.schema_evolution import ValidateSchemaEvolutionExecutor

# COMMAND ----------

# Build context
context = TaskContext(
    task_name="Validate_Schema_Evolution",
    entity=entity_name,
...
executor = ValidateSchemaEvolutionExecutor(context)
